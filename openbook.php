...
<?php
$brandjsonurl = "http://www.bbc.co.uk/programmes/b006qp6p.json";
...
$indexjsonurl = "http://www.bbc.co.uk/programmes/b006qp6p/episodes/player.json/";
...
{
	if (strpos($trend->content, "Publisher:") !== false)
	{
